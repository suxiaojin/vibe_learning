...
function RichTextEditor({
  ...
  const [formHtml, setFormHtml] = useState(initialHtml);
...
function RichTextDisplay({ value }: { value: string }) {
  ...
  return <div className="min-h-[150px] bg-[#d9e5fb] px-4 py-4 text-base leading-8 text-[#071b38] [&_img]:my-3 [&_img]:h-auto [&_img]:max-w-full [&_td]:min-w-0 [&_td]:border [&_td]:border-[#8ea3c2] [&_td]:bg-white/35 [&_td]:px-2 [&_td]:py-1 [&_table]:my-2 [&_table]:max-w-full [&_table]:border-collapse" dangerouslySetInnerHTML={{ __html: html }} />;
}
