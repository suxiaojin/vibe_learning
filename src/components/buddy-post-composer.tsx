        ...
        <div className="flex min-w-0 flex-1 items-center gap-3">
          <div ref={pickerRef} className="relative shrink-0">
            <button
              ...
              aria-label="添加表情"
              className={`grid size-10 place-items-center rounded-full transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal/30 ${pickerOpen ? "bg-teal/10 text-teal" : "text-slate-600 hover:bg-slate-100 hover:text-teal"}`}
              title="添加表情"
              type="button"
